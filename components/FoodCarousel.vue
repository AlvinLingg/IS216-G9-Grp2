...
<template>
  <div class="relative">
    ...
    <div class="absolute top-[20px] right-[20px] bg-gray-200 rounded-xl shadow-xl">
      <heart-solid class="text-md m-3 cursor-pointer" @click="handleClick" :class="{'text-red-600':liked, 'text-gray-600':!liked}"/>
    </div>
  </div>
</template>
