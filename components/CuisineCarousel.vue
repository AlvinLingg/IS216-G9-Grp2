<template>
  ...
  <div id="container">
    <button v-on:click="shiftleft()" id="handle" class="bg-gray-600 hover:bg-gray-700 active:scale-y-110 rounded-r-xl">&#8249;
    </button>
    ...
    <button v-on:click="shiftright()" id="handle" class="bg-gray-600 hover:bg-gray-700 active:scale-y-110 rounded-l-xl">&#8250;
    </button>
  </div>
  </div>
