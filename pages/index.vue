<template>
  ...
  <div class="section p-5 max-w-6xl m-auto">
    <div class="flex flex-col gap-5">
      ...
      >
        <RecipeCard
          :recipes="recipesOfTheDay.recipes"
    ...
    <div class="flex flex-col gap-5 mt-10">
      ...
      >
        <RecipeCard
          :recipes="Object.values(popularRecipesInfo)"
          :showIngredients="true"
          :showPreparationTime="true"
        />
      </div>
...
let popularRecipesInfo = ref(
  await getRecipeInformationBulk(0, popularRecipesID.value.join(","))
);
</script>
