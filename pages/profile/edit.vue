      ...
      <div class="flex flex-col gap-5 mt-5 justify-center">
        <div class="form-control">
          ...
          <div
            ...
            <img v-if="uploadedFile !== null || previewURL !== ''" :src="previewURL" alt=""
        ...
        <div class="form-control">
          ...
          <span v-if="!isHandleValid" class="mt-2 text-red-500 text-sm">That handle has been taken. Please choose
            another handle.</span>
          <span v-if="isHandleEmpty" class="mt-2 text-red-500 text-sm">Profile handle cannot be empty. Please choose a
            handle.</span>
        </div>
