    ...
    <div class="section p-10 max-w-6xl m-auto">
      ...
      >
        ...
        <div class="mt-5">
          ...
          <div class="grid grid-cols-3 gap-5 mt-5">
            <div
              ...
              class="w-full border p-5 rounded-xl flex indicator"
            >
              <span
                class="indicator-item badge bg-[#e94249] border-[#e94249] py-3 cursor-pointer"
              ...
              <div class="flex flex-row gap-5">
                <img
                  :src="url"
                  :alt="index"
                  class="rounded-xl object-cover w-12 h-12"
                />
        ...
        <div class="mt-5">
          <div class="grid grid-cols-3 gap-5">
            <div class="flex flex-col col-span-3">
              ...
              <Field
                type="text"
                class="p-3 mb-0.5 mt-2 w-full border border-gray-300 rounded"
                name="recipeName"
              />
        ...
        <div class="mt-5">
          ...
          <div
            class="flex text-lg pt-2 items-center"
            v-for="(item, key, index) in selectedIngredients"
            :key="index"
          >
            <input
